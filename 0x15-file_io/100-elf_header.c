 ...
 *
 * Description: If file not an ELF file display exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 *
 * Description: If file cannot be closed give exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - Gives the information contained in the
 ...
 *              the function fails give exit code 98.
 */
